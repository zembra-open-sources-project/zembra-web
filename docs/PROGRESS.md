...
- 前端工程基础设施：`src/app/`、`src/api/`、`src/features/notes/`、`src/pages/home/`、`src/styles/`。
- 部署初始化：`Dockerfile`、`nginx.conf`、`vercel.json`。
- 依赖约束文档：`docs/request-clarify/dependency-constraints.md`、`docs/references/dependency-constraints.md`。
